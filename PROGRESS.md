...
## Phase 2 — Features
- [~] Core: compress/extract, presets, drag-and-drop — `state-management` · `persistence-patterns` (2026-08-14: engine + zip/7z/tar.gz/tar.zst create, 10-format extract incl. rar, presets, GUI drag-and-drop + queue + persistence ALL DONE; remaining: standalone single-file codecs gz/xz/zst)
